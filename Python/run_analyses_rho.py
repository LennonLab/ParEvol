...
if __name__ == '__main__':
    ...
    if analysis == True:
        ...
        #rs.run_ba_cov_sims(gene_list=[8, 16, 32, 64, 128], pop_list=[50],
        ...
        #rs.run_ba_cov_prop_sims(run_ba_cov_prop_sims_out, covs = [0.1, 0.15, 0.2],
        #    props=props, shape=1, scale=1, G = 50, N = 50, iter1=iter1, iter2=iter2)

        # rho vs power
        rhos_out = out_path + '/data/simulations/' + 'ba_cov_rho_sims.txt'
        rs.run_ba_cov_rho_sims(rhos_out, covs = [0.2, 0.15, 0.1], rhos=[-0.5, -0.25, 0, 0.25, 0.5],
            shape=1, scale=1, G = 50, N = 50, iter1=10, iter2=1000)
